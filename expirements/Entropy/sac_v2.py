  ...
  def train(self, batch_size=256):
    ...
    if len(self.memory) >= learning_start:
      ...
      with torch.no_grad():
        ...
        #print( nq1.shape, nq2.shape, q_targ.shape)
        #print( rewards.shape, q_targ.view(-1).shape, dones.shape)
        #print(nlog_probs.shape, nactions.shape)
      ...
      if self.update_step % 20 == 0: # TD 3 Delayed update support
        # target networks
